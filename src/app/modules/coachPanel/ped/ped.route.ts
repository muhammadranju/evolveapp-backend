...
router.get(
  ...
  controller.getPEDByWeek,
);

router.patch('/update/:pedId', controller.updateAthletePEDById);

router.delete(
  '/:pedId/category/:categoryId/subcategory/:subCategoryId',
  controller.removeSubCategoryFromPED,
);

router.delete('/:pedId/category/:categoryId', controller.removeCategoryFromPED);
